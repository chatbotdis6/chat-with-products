...
def listar_archivos_productos(s3_client, bucket, prefix):
    ...
    return [content['Key'] for content in response.get('Contents', []) if content['Key'].endswith('_productos.csv')]
...
if __name__ == "__main__":
    ...
    # 2. Instancia el ingestor y crea la BBDD
    ...
    # 3. Carga productos desde todos los CSV remotos
